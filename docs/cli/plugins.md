...
- Non-bundled conversation hooks (`llm_input`, `llm_output`, `before_model_resolve`, `before_agent_reply`, `before_agent_run`, `before_agent_finalize`, `acp_terminal`, `agent_end`) require `plugins.entries.<id>.hooks.allowConversationAccess=true`.
